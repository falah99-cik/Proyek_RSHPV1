        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    <img src="{{ $user->foto ? asset('uploads/dokter/'.$user->foto) : asset('assets/adminlte/img/user.png') }}"
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="text-muted">{{ $dokter->no_hp ?? '-' }}</p>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <p class="mb-1 fw-bold">Bidang / STR Hewan</p>
                            <p class="text-muted">{{ $dokter->bidang_dokter ?? '-' }}</p>
                        </div>
